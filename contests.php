...
<body>
    ...
    <script>
     ...
     document.cp_instances.push({'all_views':'custWeek1Res,cust3Week,custMonth', 'def_view':'custMonth', 'time_unit':1440, 'resources':[{"id":"Resource_1","title":"Resource 1","granulation":"1440","click_url":null}], 'resource_id': "Resource_1", 'jsonp_url':{url:"https://www.planyo.net/fetch-calendar.php?eh=a21715fc9e0f7cb4296a5a665c91000ef7aee7b7&ih=0d1d5845b0c17b29fb540c8add8cb4b2056e17b9&callback=?", cache: false}, 'timezone':'site', 'tz_offset': 0, 'min_hour':'8:00:00', 'max_hour':'20:00:00', 'open_frame':"_top", 'element_id':'cpcal_planyonet', 'fetching_id':'cp_fetch_cpcal_planyonet', 'lng': 'en'});
     document.cp_time_format='HH:mm'; document.cp_title_format='dddd, MMMM Do, YYYY';
     document.cp_title_format_short='ddd, MMM Do'; document.cp_s_day="day";
     document.cp_s_days="days"; document.cp_s_vert_day="vertical day";
     document.cp_s_month="month"; document.cp_s_week="week";
     document.cp_s_weeks="weeks"; document.cp_s_agenda="agenda";
     var scr0 = document.createElement('script');
     scr0.onload = function () { var scr1 = document.createElement('script');
        scr1.onload = function () {var scr2 = document.createElement('script');
            scr2.onload = function() {var scr3 = document.createElement('script');
                scr3.src = "https://www.planyo.com/embed-schedule.js"; document.head.appendChild(scr3);};
